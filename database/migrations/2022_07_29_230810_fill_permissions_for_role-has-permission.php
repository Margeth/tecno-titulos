...
class FillPermissionsForRoleHasPermission extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRoleHasPermission constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.role-has-permission.index',
            'admin.role-has-permission.create',
            'admin.role-has-permission.show',
            'admin.role-has-permission.edit',
            'admin.role-has-permission.delete',
            'admin.role-has-permission.bulk-delete',
        ]);
