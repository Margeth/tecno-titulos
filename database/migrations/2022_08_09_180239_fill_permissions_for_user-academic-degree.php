...
class FillPermissionsForUserAcademicDegree extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForUserAcademicDegree constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.user-academic-degree',
            'admin.user-academic-degree.index',
            'admin.user-academic-degree.create',
            'admin.user-academic-degree.show',
            'admin.user-academic-degree.edit',
            'admin.user-academic-degree.delete',
            'admin.user-academic-degree.bulk-delete',
        ]);
