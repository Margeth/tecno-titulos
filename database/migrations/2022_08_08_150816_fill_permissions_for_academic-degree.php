...
class FillPermissionsForAcademicDegree extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAcademicDegree constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.academic-degree',
            'admin.academic-degree.index',
            'admin.academic-degree.create',
            'admin.academic-degree.show',
            'admin.academic-degree.edit',
            'admin.academic-degree.delete',
            'admin.academic-degree.bulk-delete',
        ]);
