...
class FillPermissionsForRequirement extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRequirement constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.requirement',
            'admin.requirement.index',
            'admin.requirement.create',
            'admin.requirement.show',
            'admin.requirement.edit',
            'admin.requirement.delete',
            'admin.requirement.bulk-delete',
        ]);
