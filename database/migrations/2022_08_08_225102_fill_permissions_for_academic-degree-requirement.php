...
class FillPermissionsForAcademicDegreeRequirement extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAcademicDegreeRequirement constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.academic-degree-requirement',
            'admin.academic-degree-requirement.index',
            'admin.academic-degree-requirement.create',
            'admin.academic-degree-requirement.show',
            'admin.academic-degree-requirement.edit',
            'admin.academic-degree-requirement.delete',
            'admin.academic-degree-requirement.bulk-delete',
        ]);
