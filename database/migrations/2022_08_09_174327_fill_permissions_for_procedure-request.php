...
class FillPermissionsForProcedureRequest extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForProcedureRequest constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.procedure-request',
            'admin.procedure-request.index',
            'admin.procedure-request.create',
            'admin.procedure-request.show',
            'admin.procedure-request.edit',
            'admin.procedure-request.delete',
            'admin.procedure-request.bulk-delete',
        ]);
