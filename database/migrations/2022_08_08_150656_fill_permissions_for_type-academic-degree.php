...
class FillPermissionsForTypeAcademicDegree extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTypeAcademicDegree constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.type-academic-degree',
            'admin.type-academic-degree.index',
            'admin.type-academic-degree.create',
            'admin.type-academic-degree.show',
            'admin.type-academic-degree.edit',
            'admin.type-academic-degree.delete',
            'admin.type-academic-degree.bulk-delete',
        ]);
